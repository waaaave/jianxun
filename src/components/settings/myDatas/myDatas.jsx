    ...
    <div className="myDatas">
      <div className="myDatas-inform">
        <ul className='myDatas-ul'>
          ...
          <li className='myDatas-li' onClick={() => history.push('/jianxun/comments')}><img src={ lock } alt="" /><p>我的评论</p></li>
          <li className='myDatas-li' onClick={() => history.push('/jianxun/liked')}><img src={ lock } alt="" /><p>我的收藏</p></li>
